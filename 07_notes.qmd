...
![](figures/Chapter7/7_1.png)

## Polynomials and Step Functions
![](figures/Chapter7/7_2.png)
...
- It is the sum of the diagonal elements of $$
$$\hat{g}_\lambda = \mathbf{S}_lambda y$$
...
$$\hat{g}_1 =\underset{g}{\text{arg_min}} (\sum_{i=1}^n (y_i - g(x_i))^2 \lambda \int [g^{(3)(x)}]^2) dx $$
$$ \hat{g}_2 =\underset{g}{\text{arg_min}} (\sum_{i=1}^n (y_i - g(x_i))^2 \lambda \int [g^{(4)(x)}]^2) dx$$ 
